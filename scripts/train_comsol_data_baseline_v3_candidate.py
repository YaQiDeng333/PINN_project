...
DEFAULT_SUMMARY = PROJECT_ROOT / "results/summaries/comsol_data_baseline_v3_training_summary.txt"
DEFAULT_AUDIT_SUMMARY = PROJECT_ROOT / "results/summaries/comsol_data_baseline_v3_failure_audit_summary.txt"
DEFAULT_METRICS = PROJECT_ROOT / "results/metrics/comsol_data_baseline_v3_metrics.csv"
DEFAULT_EPOCH_LOG = PROJECT_ROOT / "results/metrics/comsol_data_baseline_v3_epoch_log.csv"
DEFAULT_SEED_SUMMARY = PROJECT_ROOT / "results/metrics/comsol_data_baseline_v3_seed_summary.csv"
DEFAULT_DEFECT_GROUP_SUMMARY = PROJECT_ROOT / "results/metrics/comsol_data_baseline_v3_defect_group_summary.csv"
DEFAULT_TASK_GROUP_SUMMARY = PROJECT_ROOT / "results/metrics/comsol_data_baseline_v3_task_group_summary.csv"
DEFAULT_DEFECT_TYPE_SUMMARY = PROJECT_ROOT / "results/metrics/comsol_data_baseline_v3_defect_type_summary.csv"
DEFAULT_CONNECTED_SUMMARY = PROJECT_ROOT / "results/metrics/comsol_data_baseline_v3_connected_component_summary.csv"
DEFAULT_COMPONENT_COUNT_SUMMARY = PROJECT_ROOT / "results/metrics/comsol_data_baseline_v3_component_count_summary.csv"
DEFAULT_COMPONENT_SUMMARY = PROJECT_ROOT / "results/metrics/comsol_data_baseline_v3_component_combination_summary.csv"
DEFAULT_SOURCE_SUMMARY = PROJECT_ROOT / "results/metrics/comsol_data_baseline_v3_source_summary.csv"
DEFAULT_FAILURE_CASES = PROJECT_ROOT / "results/metrics/comsol_data_baseline_v3_failure_cases.csv"
DEFAULT_PREVIEW_DIR = PROJECT_ROOT / "results/previews/comsol_data_baseline_v3_candidate"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train COMSOL_DATA_BASELINE_V3 combined candidate.")
...
def build_training_summary(context: dict[str, Any]) -> str:
    lines = [
        "# COMSOL_DATA_BASELINE_V3 candidate training summary",
        "",
        ...
        f"- should document as COMSOL_DATA_BASELINE_V3: {context['document_baseline_v3']}",
        "",
        "## Limitations",
        "",
...
def build_audit_summary(context: dict[str, Any]) -> str:
    lines = [
        "# COMSOL_DATA_BASELINE_V3 candidate failure audit",
        "",
        ...
        f"- combined baseline stable enough to document: {context['document_baseline_v3']}",
        "",
        "## Interpretation",
        "",
...
def main() -> int:
    ...
    document_baseline_v3 = not single_degraded and not cc2_degraded and not cc3_degraded and multi_pred_cc_ok
    context = {
        "npz_readable": True,
        ...
        "document_baseline_v3": document_baseline_v3,
        ...
        "interpretation": (
            "Combined training is acceptable as a COMSOL_DATA_BASELINE_V3 candidate because it preserves component-count behavior "
            "and does not show substantial degradation against the single-defect, cc2, or cc3 data-domain baselines."
            if document_baseline_v3
            else "Combined training should not be documented as COMSOL_DATA_BASELINE_V3 yet because one or more degradation/component criteria failed."
        ),
    }
        ...
        json.dumps(
            {
                ...
                "document_baseline_v3": context["document_baseline_v3"],
