#!/usr/bin/env python
"""Write the 20.96 liftoff-conditioned inference metadata contract."""
...
ROOT = pilot.ROOT
OUT = ROOT / "results/summaries/true_3d_rbc_liftoff_inference_metadata_contract.md"


def main() -> int:
    text = """# True 3D RBC Liftoff-Conditioned Inference Metadata Contract
