#!/usr/bin/env python
"""写出 22.7 internal defect abstention inference contract。"""
...
CONTRACT_PATH = ROOT / "results/summaries/internal_defect_inference_abstention_contract.md"


def main() -> int:
    text = """# Internal defect inference with abstention contract
