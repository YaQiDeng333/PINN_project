...
- prediction_dir: `experiments\dual_network\S311_center_anchored_bounded_local_output_quick_gate\bounded_local_fixed_grid`
...
- train: mean IoU `0.995925`, zero-IoU `0/30`, local_vertex_mae_grid `0.014301`, both-bin acc `1.000000`.
- val: mean IoU `0.024490`, zero-IoU `9/10`, local_vertex_mae_grid `3.633342`, both-bin acc `0.000000`.
- test: mean IoU `0.060554`, zero-IoU `8/10`, local_vertex_mae_grid `2.862006`, both-bin acc `0.083333`.

## Interpretation

- both-bin-correct components local_vertex_mae_grid: `0.024417`.
- bin-wrong components local_vertex_mae_grid: `3.381607`.
