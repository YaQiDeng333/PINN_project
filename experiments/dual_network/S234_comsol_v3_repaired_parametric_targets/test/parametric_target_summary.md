...
- `center_x`: min=1125.52, max=3770.4, mean=2371.83
- `center_y`: min=1200, max=2298.86, mean=1647.01
- `axis_x`: min=420, max=840, mean=644.5
- `axis_y`: min=110, max=260, mean=177.5
