...
- mean hard polygon IoU: `0.731445`
- min hard polygon IoU: `0.518519`
- mean oracle IoU from target vertices: `1.000000`
- min oracle IoU from target vertices: `1.000000`
- worst sample: `21` with IoU `0.518519` and area diff `-3` pixels
- worst component max dx/dy cells: `1.084755` / `2.221350`
