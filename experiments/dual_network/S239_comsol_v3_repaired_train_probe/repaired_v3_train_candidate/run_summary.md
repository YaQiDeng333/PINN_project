...
- train_npz: `experiments/dual_network/S233_comsol_v3_repaired_hard_case_ingest/converted/train_comsol_v3_repaired_hard_case.npz`
- val_npz: `experiments/dual_network/S233_comsol_v3_repaired_hard_case_ingest/converted/val_comsol_v3_repaired_hard_case.npz`
- test_npz: `experiments/dual_network/S233_comsol_v3_repaired_hard_case_ingest/converted/test_comsol_v3_repaired_hard_case.npz`
- train_targets: `experiments/dual_network/S234_comsol_v3_repaired_parametric_targets/train/parametric_targets.npz`
- seed: `1`
- steps: `1500`
- lr: `0.001`
- hidden_dim: `128`
...
- `center_x`: mean=2200.48, std=872.015
- `center_y`: mean=1476.76, std=403.45
- `axis_x`: mean=664, std=137.091
- `axis_y`: mean=183, std=46.897
...
- `y_min`: 0.0
- `y_max`: 3000.0
- `dx`: 22.613065326633166
- `dy`: 30.303030303030305
- `bin_width_x`: 180.90452261306532
- `bin_width_y`: 242.42424242424244
- `center_x_bins`: 25
- `center_y_bins`: 13

## Final metrics

- `train`: presence_accuracy=1.000000e+00, type_accuracy_present=1.000000e+00, continuous_mae_mean=1.969904e-01, param_mask_iou=9.988506e-01
- `val`: presence_accuracy=1.000000e+00, type_accuracy_present=1.000000e+00, continuous_mae_mean=9.823816e+01, param_mask_iou=5.287356e-02
- `test`: presence_accuracy=1.000000e+00, type_accuracy_present=1.000000e+00, continuous_mae_mean=9.120485e+01, param_mask_iou=1.971426e-01
