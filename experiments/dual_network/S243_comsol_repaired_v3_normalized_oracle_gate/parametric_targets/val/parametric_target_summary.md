...
- npz_path: `experiments\dual_network\S242_comsol_repaired_v3_normalized_ingest\converted\val_comsol_v3_repaired_normalized_hard_case.npz`
- raw defect rows: `10`
- samples: `10`
- max_components: `3`
...
- `center_x`: min=-0.0261083, max=0.0197277, mean=-0.00387761
- `center_y`: min=-0.0046, max=0.00237374, mean=-0.000868283
- `axis_x`: min=0.008, max=0.0156444, mean=0.0118489
- `axis_y`: min=0.0008, max=0.00173333, mean=0.0012
