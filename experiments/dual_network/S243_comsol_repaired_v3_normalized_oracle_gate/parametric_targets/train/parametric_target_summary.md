...
- `center_x`: min=-0.0274832, max=0.0270294, mean=-0.000880291
- `center_y`: min=-0.0046, max=0.00561616, mean=-0.00015495
- `axis_x`: min=0.00746667, max=0.0156444, mean=0.0118044
- `axis_y`: min=0.000733333, max=0.00173333, mean=0.00122
