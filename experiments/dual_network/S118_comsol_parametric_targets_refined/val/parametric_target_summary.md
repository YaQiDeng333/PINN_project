...
- `center_x`: min=-0.0202, max=0.0202, mean=3.10441e-11
- `center_y`: min=-0.0057, max=0.005, mean=-0.000193333
- `axis_x`: min=0.004, max=0.0056, mean=0.00493333
- `axis_y`: min=0.005, max=0.0066, mean=0.00588
- `depth_or_shape_param`: min=0.001, max=0.0025, mean=0.0018125
- `rotation_angle`: min=-30, max=30, mean=-3.5
