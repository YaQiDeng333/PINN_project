...
代表性 preview、loss curve 和 summary 的具体保留理由见 `ARTIFACT_RETENTION_NOTES.md`。旧 review / preflight / route-decision 文档、大量逐样本日志、非 internal 中间 feature / training metrics 已删除，不作为复现迁移资产；internal-defect 相关代表性 metrics 保留。
